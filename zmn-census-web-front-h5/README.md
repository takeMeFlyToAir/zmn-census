...
git clone https://github.com/sunniejs/zmn-census-web-front-h5.git

cd zmn-census-web-front-h5
...
zmn-census-web-front-h5 所有全局样式都在 `@/src/assets/css` 目录下设置
